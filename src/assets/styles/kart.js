...
export const KartTotalWrapper = Style.div`
  width: 85%;
  margin: 1px auto;
  font-family: Roboto sans-serif;
`;

export const KartTotalTitle = Style.h1`
  font-family: Roboto sans-serif;
  color: rgb(61, 70, 77);
  margin-bottom: 20px;
  margin-top: 55px;
...
export const KartTotalFlex = Style.div`
  display: flex;
  justify-content: space-between;
  color: rgb(61, 70, 77);
  padding: 20px 0;
  border-bottom: ${props => props.b && '1px solid #ccc'}
`;

export const KartText = Style.div`
  font-weight: ${props => props.bold ? 'bold' : ''};
  font-size: ${props => props.sm ? '1rem' : '1.5rem'};
`;

export const KartCheckoutButton = Style.div`
  background: rgb(255, 211, 51);
  color: rgb(61, 70, 77);
  font-weight: bold;
  font-size: 1.4rem;
