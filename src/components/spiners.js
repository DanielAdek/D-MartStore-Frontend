...
export const DualRingLoadScreen = () => (
  <Spiner loadingText={true} fullScreen={true} type="dual-ring" size={150}/>
);
export const DualRingLoad = () => (
  <Spiner pos="relative" type="dual-ring" t="-5px" l="16px" mh="35px" size={30}/>
);
export const RingLoadScreen = () => (
  <Spiner loadingText={true} fullScreen={true} type="ring" size={30}/>
);
export const RingLoad = () => (
  <Spiner pos="relative" type="ring" t="-5px" l="16px" mh="35px" size={30}/>
);
export const DefaultLoadScreen = () => (
  <Spiner loadingText={true} fullScreen={true} size={150}/>
);
export const DefaultLoad = () => (
  <Spiner pos="relative" t="-5px" l="16px" mh="35px" size={30}/>
);
export const EllipsisLoadScreen = () => (
  <Spiner loadingText={true} fullScreen={true} type="ellipsis" size={150}/>
);
export const EllipsisLoad = () => (
  <Spiner pos="relative" type="ellipsis" t="-5px" l="16px" mh="35px" size={30}/>
);
export const RollerLoadScreen = () => (
  <Spiner loadingText={true} fullScreen={true} type="roller" size={150}/>
);
