      ...
      <RC.Body>
          ...
          <RC.ContentBody>
            <RC.ProductRightSide>
              ...
              <hr />
              <RC.ProductStatus>
                <RC.ProductStatText>Avaliablilty: <RC.ProductStatusColor statusText={props.currentData.product.productAvailablility === 'In Stock' ? '#28a745': '#ffd333'}>{props.currentData.product.productAvailablility}</RC.ProductStatusColor> </RC.ProductStatText>
              ...
              <RC.ProductActionButtonSec>
                <RC.ProductActionButton className="btn" bgColor="#ffd333" hClr="#9b9b9b">Add Cart</RC.ProductActionButton>
                <RC.ProductActionButton className="btn" bgColor="blue" clr="#f3f3f3" hClr="#dbd8d8">WishList</RC.ProductActionButton>
              </RC.ProductActionButtonSec>
              </RC.ProductActionsSection>
            </RC.ProductRightSide>
            <RC.ProductImagesContainer>
              { props.currentData.product.productImages.map((dat, i) => (<RC.ProductImages onClick={() => props.handleImageToManify(dat)} src={dat.image} />))}
            </RC.ProductImagesContainer>
          </RC.ContentBody>
        </RC.Body>
    </Fragment>
